...
public:
    ...
    virtual void read(Context *ctx, std::shared_ptr<DataPacket> packet, const std::string &stream_id){};
    ...
    virtual void write(Context *ctx, std::shared_ptr<DataPacket> packet, const std::string &stream_id){};
