...
class MediaStream;
using licode::webrtc::RemoteBitrateEstimator;
using licode::webrtc::RemoteBitrateObserver;
using licode::webrtc::RtpHeaderExtensionMap;
...
class RemoteBitrateEstimatorPicker {
 public:
  virtual std::unique_ptr<RemoteBitrateEstimator> pickEstimator(bool using_absolute_send_time,
    licode::webrtc::Clock* const clock, RemoteBitrateObserver *observer);
};
...
class BandwidthEstimationHandler: public Handler, public RemoteBitrateObserver,
 ...
 private:
  ...
  std::unique_ptr<licode::webrtc::RemoteBitrateEstimator> rbe_;
  bool using_absolute_send_time_;
  uint32_t packets_since_absolute_send_time_;
  int min_bitrate_bps_;
  licode::webrtc::RTPHeader header_;
  RtcpHeader remb_packet_;
  licode::webrtc::RtpHeaderExtensionMap ext_map_audio_, ext_map_video_;
  uint32_t bitrate_;
