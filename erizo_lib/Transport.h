...
public:
    ...
    Transport(MediaType med, const std::string &transport_name, const std::string &connection_id, bool bundle,
              ...
              std::shared_ptr<Worker> worker, std::shared_ptr<IOWorker> io_worker) : mediaType(med), transport_name(transport_name), rtcp_mux_(rtcp_mux), transport_listener_(transport_listener),
