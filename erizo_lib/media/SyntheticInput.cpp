...
static constexpr uint32_t kDefaultVideoBitrate = 400000;  // bps
...
int SyntheticInput::deliverFeedback_(std::shared_ptr<DataPacket> fb_packet, const std::string &stream_id) {
