...
class StreamMixer : public MediaSink, public MediaSource, public FeedbackSink, public FeedbackSource, public rtc::VideoSourceBase, public webrtc::Transport, public std::enable_shared_from_this<StreamMixer>
{
    DECLARE_LOGGER();
