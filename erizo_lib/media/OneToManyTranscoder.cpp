...
int OneToManyTranscoder::deliverAudioData_(std::shared_ptr<DataPacket> audio_packet, const std::string &stream_id) {
...
int OneToManyTranscoder::deliverVideoData_(std::shared_ptr<DataPacket> video_packet, const std::string &stream_id) {
