...
#ifndef LICODE_WEBRTC_COMMON_TYPES_H_
#define LICODE_WEBRTC_COMMON_TYPES_H_
...
struct RtpPacketCounter {
  ...
  void Subtract(const RtpPacketCounter& other) {
    LICODE_RTC_DCHECK_GE(header_bytes, other.header_bytes);
    header_bytes -= other.header_bytes;
    LICODE_RTC_DCHECK_GE(payload_bytes, other.payload_bytes);
    payload_bytes -= other.payload_bytes;
    LICODE_RTC_DCHECK_GE(padding_bytes, other.padding_bytes);
    padding_bytes -= other.padding_bytes;
    LICODE_RTC_DCHECK_GE(packets, other.packets);
    packets -= other.packets;
  }
