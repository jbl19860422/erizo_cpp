...
#ifndef LICODE_WEBRTC_MODULES_RTP_RTCP_INCLUDE_RTP_PAYLOAD_REGISTRY_H_
#define LICODE_WEBRTC_MODULES_RTP_RTCP_INCLUDE_RTP_PAYLOAD_REGISTRY_H_
...
class RTPPayloadRegistry {
 public:
  ...
  LICODE_RTC_DEPRECATED void set_use_rtx_payload_mapping_on_restore(bool val) {}
