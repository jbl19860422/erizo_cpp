...
#ifndef LICODE_WEBRTC_MODULES_RTP_RTCP_INCLUDE_RTP_RTCP_H_
#define LICODE_WEBRTC_MODULES_RTP_RTCP_INCLUDE_RTP_RTCP_H_
...
class RtpRtcp : public Module {
 public:
  ...
  // Returns -1 on failure else 0.
  LICODE_RTC_DEPRECATED virtual int32_t SetAudioPacketSize(
