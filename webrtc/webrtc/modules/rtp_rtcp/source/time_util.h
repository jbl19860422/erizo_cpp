...
#ifndef LICODE_WEBRTC_MODULES_RTP_RTCP_SOURCE_TIME_UTIL_H_
#define LICODE_WEBRTC_MODULES_RTP_RTCP_SOURCE_TIME_UTIL_H_
...
inline uint32_t NtpToRtp(licode::webrtc::NtpTime ntp, uint32_t freq) {
