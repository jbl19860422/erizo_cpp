...
#ifndef LICODE_WEBRTC_MODULES_INCLUDE_MODULE_COMMON_TYPES_H_
#define LICODE_WEBRTC_MODULES_INCLUDE_MODULE_COMMON_TYPES_H_
...
class AudioFrame {
 public:
  ...
  LICODE_RTC_DEPRECATED void Mute();
  LICODE_RTC_DEPRECATED AudioFrame& operator>>=(const int rhs);
  LICODE_RTC_DEPRECATED AudioFrame& operator+=(const AudioFrame& rhs);
