...
VideoCodecVP8* VideoCodec::VP8() {
  LICODE_RTC_DCHECK_EQ(codecType, kVideoCodecVP8);
...
VideoCodecVP9* VideoCodec::VP9() {
  LICODE_RTC_DCHECK_EQ(codecType, kVideoCodecVP9);
...
VideoCodecH264* VideoCodec::H264() {
  LICODE_RTC_DCHECK_EQ(codecType, kVideoCodecH264);
...
bool BitrateAllocation::SetBitrate(size_t spatial_index,
  ...
  LICODE_RTC_CHECK_LT(spatial_index, kMaxSpatialLayers);
  LICODE_RTC_CHECK_LT(temporal_index, kMaxTemporalStreams);
  LICODE_RTC_CHECK_LE(bitrates_[spatial_index][temporal_index], sum_);
