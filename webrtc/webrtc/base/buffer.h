...
#ifndef LICODE_WEBRTC_BASE_BUFFER_H_
#define LICODE_WEBRTC_BASE_BUFFER_H_
...
class BufferT {
 ...
 public:
  ...
  T& operator[](size_t index) {
    LICODE_RTC_DCHECK_LT(index, size_);
    return data()[index];
  }
  ...
  size_t AppendData(size_t max_elements, F&& setter) {
    ...
    LICODE_RTC_CHECK_LE(written_elements, max_elements);
