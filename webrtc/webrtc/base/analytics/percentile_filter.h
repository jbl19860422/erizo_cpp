...
#ifndef LICODE_WEBRTC_BASE_ANALYTICS_PERCENTILE_FILTER_H_
#define LICODE_WEBRTC_BASE_ANALYTICS_PERCENTILE_FILTER_H_
...
PercentileFilter<T>::PercentileFilter(float percentile)
    : percentile_(percentile),
      ...
      percentile_index_(0) {
  LICODE_RTC_CHECK_GE(percentile, 0.0f);
  LICODE_RTC_CHECK_LE(percentile, 1.0f);
}
