...
#ifndef LICODE_WEBRTC_BASE_SEQUENCED_TASK_CHECKER_H_
#define LICODE_WEBRTC_BASE_SEQUENCED_TASK_CHECKER_H_
...
#define ENABLE_SEQUENCED_TASK_CHECKER LICODE_RTC_DCHECK_IS_ON
...
//  public:
//   void Foo() {
//     LICODE_RTC_DCHECK(sequence_checker_.CalledSequentially());
//     ... (do stuff) ...
//   }
//
//  private:
...
#define LICODE_RTC_DCHECK_CALLED_SEQUENTIALLY(x) \
