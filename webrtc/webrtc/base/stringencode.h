...
#ifndef LICODE_WEBRTC_BASE_STRINGENCODE_H_
#define LICODE_WEBRTC_BASE_STRINGENCODE_H_
...
// Safe s//printf to std::string
//void s//printf(std::string& value, size_t maxlen, const char * format, ...)
//     //printf_FORMAT(3);
