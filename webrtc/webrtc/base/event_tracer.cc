...
class EventLogger final {
 public:
  ...
  ~EventLogger() { LICODE_RTC_DCHECK(thread_checker_.CalledOnValidThread()); }
...
// https://docs.google.com/document/d/1CvAClvFfyA5R-PhYUmn5OOQtYMH4h6I0nSsKchNAySU/preview
  void Log() {
    LICODE_RTC_DCHECK(output_file_);
...
void SetupInternalTracer() {
  LICODE_RTC_CHECK(rtc::AtomicOps::CompareAndSwapPtr(
