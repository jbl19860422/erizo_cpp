...
#ifndef LICODE_WEBRTC_BASE_STRINGUTILS_H__
#define LICODE_WEBRTC_BASE_STRINGUTILS_H__
...
//  strchr, vsn//printf, strtoul, tolowercase
...
#ifndef vsn//printf
inline int vsn//printf(wchar_t* buf, size_t n, const wchar_t* fmt, va_list args) {
  return _vsnw//printf(buf, n, fmt, args);
}
#endif // !vsn//printf
...
// Safe versions of strncpy, strncat, sn//printf and vsn//printf that always
// null-terminate.
