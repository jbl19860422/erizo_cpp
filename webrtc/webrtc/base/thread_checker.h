...
#ifndef LICODE_WEBRTC_BASE_THREAD_CHECKER_H_
#define LICODE_WEBRTC_BASE_THREAD_CHECKER_H_

// Apart from debug builds, we also enable the thread checker in
// builds with LICODE_RTC_DCHECK_IS_ON so that trybots and waterfall bots
// with this define will get the same level of thread checking as
// debug bots.
#define ENABLE_THREAD_CHECKER LICODE_RTC_DCHECK_IS_ON
...
//  public:
//   void Foo() {
//     LICODE_RTC_DCHECK(thread_checker_.CalledOnValidThread());
//     ... (do stuff) ...
//   }
//
//  private:
...
// RUN_ON/ACCESS_ON/LICODE_RTC_DCHECK_RUN_ON macros allows to annotate variables are
...
//  public:
//   void NeedVar1() {
//     LICODE_RTC_DCHECK_RUN_ON(network_thread_);
//     transport_->Send();
//   }
//
//  private:
...
//     LICODE_RTC_DCHECK_RUN_ON(&pacer_thread_checker_)
...
//     void Encode() {
//       LICODE_RTC_DCHECK_RUN_ON(encoder_queue_);
//       DoSomething(var_);
//     }
//
//    private:
...
#define LICODE_RTC_DCHECK_RUN_ON(thread_like_object) \
  rtc::internal::AnnounceOnThread thread_announcer(thread_like_object); \
  LICODE_RTC_DCHECK(rtc::internal::AnnounceOnThread::IsCurrent(thread_like_object))
