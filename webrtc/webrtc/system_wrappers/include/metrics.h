...
#ifndef LICODE_WEBRTC_SYSTEM_WRAPPERS_INCLUDE_METRICS_H_
#define LICODE_WEBRTC_SYSTEM_WRAPPERS_INCLUDE_METRICS_H_
    ...
    if (!histogram_pointer) {                                              \
      ...
      webrtc::metrics::Histogram* prev_pointer =                           \
          rtc::AtomicOps::CompareAndSwapPtr(                               \
              ...
              histogram_pointer);                                          \
      LICODE_RTC_DCHECK(prev_pointer == nullptr ||                                \
                 prev_pointer == histogram_pointer);                       \
    }                                                                      \
    if (histogram_pointer) {                                               \
      LICODE_RTC_DCHECK_EQ(constant_name,                                         \
