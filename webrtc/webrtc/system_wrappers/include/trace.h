...
#ifndef LICODE_WEBRTC_SYSTEM_WRAPPERS_INCLUDE_TRACE_H_
#define LICODE_WEBRTC_SYSTEM_WRAPPERS_INCLUDE_TRACE_H_
...
class Trace {
 public:
  ...
  // msg and the ellipsis are the same as e.g. s//printf.
